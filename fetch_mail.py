...
class FecthMail:
    def __init__(self, server="pop3.gmail.com", protocol="pop3", use_ssl=True, outdir="result", default_port={"pop3": {False: 110, True: 995}, "imap4": {False:143 , True:993}})
...
#get md5 of a input file  added by mrxu
    ...
    def Test()
        print("[*] Start test download email script")
